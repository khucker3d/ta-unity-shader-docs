...
### Properties
The Properties block defines material inputs. These appear in the Material Inspector, allowing artists and developers to control shader behavior without modifying code.
...
## Standard URP PBR Shader Example
```
Shader "Custom/URP/StandardPBR"
{
    Properties
    {
